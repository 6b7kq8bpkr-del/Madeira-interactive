(function () {
  ...
  const CHECKLIST = [
    ...
    ["trails", "Bilet SIMplifica na PR1.2 Pico Ruivo (22.08) dla wszystkich; PR6 25 Fontes tylko jeśli decydujemy się na wariant 29.08"],
      ...
      <header class="print-head">
        ...
        <ul class="print-facts">
          ...
          <li><strong>Gotówka:</strong> 90 € transfery (Rui, przy przyjeździe) · 220 €/dzień za wycieczki busem, jeśli je zamówimy · ok. 8 €/os. na minibus w Rabaçal przy wariancie z levadą. Reszta wyspy na kartę.</li>
            <li><strong>Szlaki:</strong> PR1.2 Pico Ruivo 22.08 — cała grupa, bilet SIMplifica 4,50 €/os., okno 30 min, mieć offline. PR6 25 Fontes tylko jako wariant 29.08 dla chętnych (wtedy też minibus z ER105, ok. 8 €/os. gotówką)</li>
