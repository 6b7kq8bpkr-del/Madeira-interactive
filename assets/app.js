(function () {
  ...
  const CHECKLIST = [
    ...
    ["cash", "Gotówka: 90 € transfery + 290 € góry (potwierdzone) + 220–255 € zachód, jeśli go zamówimy; banany i Curral taniej lokalnie"],
  ...
  const days = [
    ...
    },
    {
      ...
      tips: ["<strong>Autobus 81</strong> (Horários do Funchal) jedzie z centrum Funchal przez Eira do Serrado do Curral das Freiras — około 45 minut serpentynami i tunelami, bilet 2–3 € od osoby. Cała siódemka w obie strony to ~40 € zamiast 120–140 € za dwie taksówki, a sama trasa jest atrakcją. Do przystanku w centrum dojedziemy taksówką spod hotelu (ok. 8 €) albo autobusem miejskim.", "Najtańszy i najciekawszy dojazd to <strong>autobus 81</strong> (Horários do Funchal): jedzie z centrum Funchal przez Eira do Serrado do Curral das Freiras, ok. 45 minut serpentynami i tunelami. Bilet ok. 2–3 € od osoby (z kartą GIRO taniej) — cała siódemka w obie strony za ~40 €, podczas gdy dwie taksówki to 120–140 €. Autobus zatrzymuje się przy punkcie widokowym.", "Podejście do punktu widokowego jest częścią planu przy suchej nawierzchni; zawrócenie pozostaje prostą opcją.", "Nie trzeba podchodzić do barierek, aby zobaczyć dolinę.", "W razie choroby lokomocyjnej usiąść z przodu i przygotować wodę.", "Dzieci mogą przejść pełny spacer; tempo dopasowujemy do najwolniejszej osoby."] ,
    ...
    root.innerHTML = `
      <header class="print-head">
        ...
        <ul class="print-facts">
          ...
          <li><strong>Gotówka:</strong> 90 € transfery (Rui) · góry 27.08: 290 € potwierdzone · zachód 24.08 z Rui: 220–255 € · banany 26.08: taxi-van ~85–180 € albo Rui, decyzja na miejscu · Curral 21.08: autobus 81, ~40 € za rodzinę · minibus Rabaçal ~8 €/os. przy wariancie levady. Reszta wyspy na kartę.</li>
