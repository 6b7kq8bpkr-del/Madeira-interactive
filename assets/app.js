(function () {
  ...
  const days = [
    ...
    },
    {
      ...
      intensity: "Aktywna", duration: "10:15–18:15", transport: "Prywatny bus + PR1.2", walking: "PR1.2 ok. 5,6 km + Balcões", kids: "Tak, dobrze chodzą po górach", exposure: "Umiarkowana; PR1.2, bez grani PR1",
    ...
    },
    {
      ...
      agenda: [["08:00", "Śniadanie w hotelu", "Bufet śniadaniowy w hotelu, zwykle 7:30–10:00 (godziny potwierdzić w recepcji)."], ["rano", "Termin zapasowy rejsu", "Jeżeli rejs z 28 sierpnia odwołano z powodu morza, dziś ma pierwszeństwo — o godzinie ustalonej z operatorem."], ["10:15", "Machico", "Plaża i płaska promenada — wariant, jeśli rejs odbył się poprzedniego dnia."], ["10:15", "Funchal", "Ostatnie zakupy, kawiarnia i miejsce pominięte wcześniej."], ["10:15", "Caminho Real do Paúl do Mar", "Wariant SW dla chętnych na historyczną, wykutą w klifie królewską drogę (PR19). Domyślnie bezpiecznie: górny punkt widokowy z Prazeres na zygzak schodzący do morza i widok na Jardim do Mar. Pełny, stromy zjazd ~500 m (ok. 1,5 h) tylko dla chętnych — bus odbiera na dole w Paúl do Mar; osoba z lękiem wysokości i najmłodsze zostają przy górnym punkcie."], ["10:15", "Ulubione miejsce", "Powtórka bez poczucia, że trzeba zobaczyć coś nowego."], ["17:00", "Pakowanie", "Przygotować dokumenty, bagaże i ubrania na powrót."]],
