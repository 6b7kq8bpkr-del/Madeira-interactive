(function () {
  ...
  const CHECKLIST = [
    ...
    ["katowice", "Adres hotelu znajomych (pakiet Itaki) — potrzebny Ruiemu, jeśli 27.08 trzeba ich odebrać po drodze"],
    ...
    ["cash", "Gotówka: 35 € transfer 20.08 + 35 € powrót 30.08 + 290 € góry; zachód 220–255 €, jeśli go zamówimy"],
    ...
    root.innerHTML = `
      <header class="print-head">
        ...
        <ul class="print-facts">
          ...
          <li><strong>Transfery lotniskowe:</strong> madeira-in (Rui Nóbrega), Mercedes Sprinter — 2 × 35 EUR za czworo (20.08 i 30.08). <strong>PŁATNE GOTÓWKĄ przy przyjeździe</strong>; tel. kierowcy +351 917 260 690, mail transfers.madeira@gmail.com. Po wylądowaniu dzwonimy do Rui z kompletem bagaży, odbiór przy kawiarni obok hali przylotów</li>
          ...
          <li><strong>Gotówka:</strong> transfery (Rui): 2 × 35 € (20.08 i 30.08) · góry 27.08: 290 € potwierdzone · zachód 24.08 z Rui: 220–255 € · banany 26.08: taxi-van ~85–180 € albo Rui, decyzja na miejscu · Curral 21.08: autobus 81, ~40 € za rodzinę · minibus Rabaçal ~8 €/os. przy wariancie levady. Reszta wyspy na kartę.</li>
  ...
  const KOSZTY_GOTOWKA = [
    ...
    { co: "Transfer powrotny 30.08", staly: 35, uwaga: "Wracamy we czworo — znajomi lecą do domu osobno, w swoim terminie. Godzinę odbioru trzeba jeszcze dograć: Rui zapisał 08:45, my liczymy na 08:30." },
  ...
  const practicalInfo = [
    ...
    { emoji: "💶", title: "Ile gotówki mieć przy sobie", points: [
      "<strong>Transfery lotniskowe — dwa kursy po 35 €.</strong> Przylot 20.08 i powrót 30.08, oba we czworo. Znajomi mają transfery w pakiecie Itaki, więc 22.08 nic nie organizujemy. Rui rozlicza się gotówką na miejscu, nie kartą i nie przelewem.",
      ...
      <main id="main-content" class="guide-main">
        ...
        <section class="guide-section" aria-labelledby="rezerwacje-title">
          ...
          <div class="cash-alert">
            <strong>Gotówka na transfery: 2 × 35 € (20.08 i 30.08).</strong> Rui bierze płatność <strong>gotówką przy przyjeździe</strong> — nie kartą, nie przelewem. Banknoty przygotować jeszcze w Polsce; bankomat na FNC to niepotrzebna komplikacja z bagażami i dziećmi po locie.
          </div>
          <div class="parking-box">
            <div class="parking-facts">
              ...
              <dl>
                ...
                <dt>Cena</dt><dd>35 € za kurs dla czworga <span>— tyle za przylot 20.08 i tyle za powrót 30.08; znajomi przylatują 22.08 z własnym transferem w pakiecie</span></dd>
