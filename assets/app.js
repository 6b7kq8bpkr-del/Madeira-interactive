  ...
  const days = [
    {
      ...
      agenda: [["11:00", "Wyjazd z Łodzi", "Start bez pośpiechu; zaplanować regularne postoje dla dzieci."], ["17:00", "Parking P8 przy BER", "Wjazd zgodnie z rezerwacją, zdjęcie miejsca postoju i shuttle lub krótkie przejście do terminala."], ["17:45", "Pociąg do centrum", "FEX albo S-Bahn z dworca pod terminalem BER — do centrum około 30 minut, bez auta i bez szukania parkingu."], ["18:30", "Jeden lekki spacer", "Brama Brandenburska i Reichstag z zewnątrz albo kameralne Nikolaiviertel — bez łączenia wszystkiego."], ["19:30", "Wczesna kolacja i sen", "Proste menu, powrót pociągiem na nocleg blisko BER i wczesny sen — lot następnego ranka wychodzi o 07:00 (pobudka ~04:30)."]],
      tips: ["Nocleg wybrać jak najbliżej BER (najlepiej z własnym shuttle) — auto zostaje na P8; lot następnego ranka wychodzi o 07:00, więc liczy się krótki dojazd na lotnisko i sen.", "Przed wyjazdem pobrać mapę offline Berlina i okolic BER.", "Sprawdzić kod wjazdu, numer rezerwacji P8 i sposób transferu do terminala.", "Po drodze robić postoje najpóźniej co 90 minut; po przyjeździe zaplanować jeden spacer 1–3 km, bez długiego stania.", "Zostawić bagaże lotnicze łatwo dostępne — nie przepakowywać auta wieczorem."],
