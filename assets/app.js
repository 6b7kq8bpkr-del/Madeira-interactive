(function () {
  ...
  const POI_ATRAKCJE = [
    { n: "Queimadas — Casa das Queimadas", lat: 32.782772, lon: -16.911610, d: "22.08 · Leśny park nad strumieniami z autentycznym domem krytym strzechą, w miejsce komercyjnych domków w Santanie. Płaskie alejki i cień. Wstęp wolny, parking płatny." },
  ...
  const days = [
    ...
    {
      id: "2026-08-22", date: "22 sierpnia · sobota", title: "Pico Ruivo i wschód wyspy", short: "Wejście na najwyższy szczyt Madery (PR1.2), leśne Queimadas i levada na Balcões.",
    ...
    },
    {
      ...
      intensity: "Aktywna", duration: "10:15–18:30", transport: "Prywatny bus + spacer", walking: "Grupa A 11 km · grupa B ok. 2 km", kids: "Tak — dla młodszych osobna ścieżka", exposure: "Kontrolowana; Risco pomijamy",
      ...
      agenda: [["08:15", "Śniadanie w hotelu", "Bufet 7:30–10:00 — spokojne śniadanie przed wyjazdem (godziny potwierdzić w recepcji)."], ["10:15", "Wyjazd z hotelu", "Aktywny dzień na zachodzie; przejazd na płaskowyż Rabaçal, ok. godziny drogi."], ["11:15", "Rozdzielamy się na pół dnia", "Grupa A zostaje w Rabaçal na Levadę das 25 Fontes, grupa B jedzie busem na wybrzeże — szczegóły obu ścieżek niżej. Spotykamy się w Calhecie o 15:30."], ["15:45", "Calheta — plaża i lunch", "Znowu razem: piaszczysta plaża, późny lunch przy oceanie i kąpiel — na spokojnie, bez patrzenia na zegarek."], ["17:00", "Bananowce w Madalena do Mar", "Krótki przystanek wśród plantacji — dzieci zobaczą, jak rosną banany, i spróbują owoców prosto z krzaka. Kilka kilometrów dalej, w Lugar de Baixo, jest BAM — Muzeum Bananów (czynne do 18:00) ze zwiedzaniem plantacji doświadczalnej i filmem 4D; do rozważenia zamiast postoju przy krzakach albo obok niego."], ["17:30", "Ponta do Sol", "Lody i spacer przy oceanie w najbardziej słonecznym zakątku wyspy, w drodze powrotnej."], ["18:30", "Powrót", "Wieczór w hotelu."]],
      ...
      groups: {
        ...
        wstep: "Levada das 25 Fontes to 11 km liczone od parkingu — najdłuższy dystans całego wyjazdu. Zamiast ciągnąć na nią wszystkich, dzielimy się na pół dnia i spotykamy w Calhecie o 15:45. Bus obsługuje obie grupy: zostawia jedną w Rabaçal, wozi drugą po wybrzeżu i wraca po pierwszą.",
        listy: [
          {
            ...
            punkty: [
              ...
              ["14:45", "Powrót do Rabaçal House", "Minibus w górę na parking; pod wodospad nie schodzimy — przejście jest zamknięte na stałe."],
              ["15:45", "Dołączamy w Calhecie", "Bus przywozi grupę na plażę; lunch i kąpiel razem z resztą."]
            ]
          },
          {
            ...
            punkty: [
              ...
              ["15:45", "Spotkanie z grupą A", "Reszta dnia znowu razem."]
            ]
          }
        ],
    ...
    },
    {
      ...
      agenda: [["08:00", "Śniadanie w hotelu", "Bufet śniadaniowy w hotelu, zwykle 7:30–10:00 (godziny potwierdzić w recepcji)."], ["rano", "Termin zapasowy rejsu", "Jeżeli rejs z 28 sierpnia odwołano z powodu morza, dziś ma pierwszeństwo — o godzinie ustalonej z operatorem."], ["10:15", "Wybieramy kierunek dnia", "Jeden z czterech wariantów poniżej — decyzja zapada przy śniadaniu, po prognozie i po tym, na co grupa ma ochotę. Nie robimy ich po kolei."], ["do wyboru", "Machico", "Plaża i płaska promenada — wariant, jeśli rejs odbył się poprzedniego dnia."], ["do wyboru", "Funchal", "Ostatnie zakupy, kawiarnia i miejsce pominięte wcześniej."], ["do wyboru", "Caminho Real do Paúl do Mar", "Wariant SW dla chętnych na historyczną, wykutą w klifie królewską drogę (PR19). Domyślnie bezpiecznie: górny punkt widokowy z Prazeres na zygzak schodzący do morza i widok na Jardim do Mar. Pełny, stromy zjazd ~500 m (ok. 1,5 h) tylko dla chętnych — bus odbiera na dole w Paúl do Mar; osoba z lękiem wysokości i najmłodsze zostają przy górnym punkcie."], ["do wyboru", "Ulubione miejsce", "Powtórka bez poczucia, że trzeba zobaczyć coś nowego."], ["17:00", "Pakowanie", "Przygotować dokumenty, bagaże i ubrania na powrót."]],
    ...
    root.innerHTML = `
      <header class="print-head">
        ...
        <ul class="print-facts">
          ...
          <li><strong>Gotówka:</strong> 90 € transfery (Rui, przy przyjeździe) · ok. 56 € minibus Rabaçal 27.08 · 220 €/dzień za wycieczki busem, jeśli je zamówimy. Reszta wyspy na kartę.</li>
  ...
  const practicalInfo = [
    ...
    { emoji: "💶", title: "Ile gotówki mieć przy sobie", points: [
      ...
      "<strong>ok. 56 € — minibus w Rabaçal</strong> (27.08, 8 € od osoby w obie strony). Płatny wyłącznie gotówką, więc drobne muszą być tego dnia w kieszeni, nie w hotelu.",
  ...
  const maklowicz = [
    { emoji: "🍷", name: "Quinta do Furão", where: "Santana", day: "22.08 — lunch po Pico Ruivo", desc: "Restauracja na skraju klifu w Achada do Gramacho, wśród własnych winnic, z tarasem nad dzikim północnym wybrzeżem. Kuchnia maderska bez przebrania za międzynarodową: espetada, dorsz, stek. Wpada nam idealnie w lunch po zejściu ze szczytu — ale to miejsce, do którego lepiej zadzwonić z wyprzedzeniem." },
