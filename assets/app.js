(function () {
  ...
  const CHECKLIST = [
    ...
    ["cash", "Gotówka: 90 € transfery + 290 € góry (potwierdzone) + 220–255 € zachód; banany i Curral taniej lokalnie — razem ok. 650–700 €"],
    ...
    root.innerHTML = `
      <header class="print-head">
        ...
        <ul class="print-facts">
          ...
          <li><strong>Gotówka:</strong> 90 € transfery (Rui) · góry 27.08: 290 € potwierdzone · zachód 24.08 z Rui: 220–255 € · banany 26.08: taxi-van ~85–180 € albo Rui, decyzja na miejscu · Curral 25.08: autobus 81, ~40 € za rodzinę · minibus Rabaçal ~8 €/os. przy wariancie levady. Reszta wyspy na kartę.</li>
  ...
  const practicalInfo = [
    ...
    { emoji: "💶", title: "Ile gotówki mieć przy sobie", points: [
      ...
      "<strong>Ok. 500–750 € — transport na wycieczki.</strong> Pewne jest 290 € za dzień górski z Rui (27.08, potwierdzone). Zachód 24.08 też z Rui: 220 € do 17:00, 255 € do 18:00 — na Fanal nic innego nie dojeżdża. Dzień bananowy 26.08 ma tańsze opcje: taxi-van do 8 osób za ~85–180 € albo linia 142 za grosze; decyzja na miejscu. Do Curral 25.08 jedzie autobus 81 za ~40 € za całą rodzinę.",
