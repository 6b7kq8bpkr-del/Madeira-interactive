(function () {
  ...
  const FLEX = {
    ...
    "2026-08-27": ["Pico Ruivo i Balcões — oba z opłaconymi biletami", "obiad w Faial można skrócić"],
  ...
  const CHECKLIST = [
    ...
    ["katowice", "Lot rodziny z Katowic 22.08 (Enter Air) — numer i godzina lądowania przekazane Ruiemu"],
    ...
    ["cash", "Gotówka: 35 € transfer 20.08 + kurs z lotniska 22.08 + 45 € powrót 30.08 + 290 € góry; zachód 220–255 €, jeśli go zamówimy"],
  ...
  const days = [
    {
      id: "2026-08-19", date: "19 sierpnia · środa", title: "Łódź → Berlin", short: "Popołudniowy przejazd do Berlina, parking P7/8 i nocleg przy terminalu.",
      image: images.berlin, alt: "Brama Brandenburska w Berlinie o wieczornej porze", cats: ["podróż", "spokojny"],
      intensity: "Łagodna", duration: "12:30–21:00, w tym ~5 h drogi", transport: "Samochód · w Berlinie pociąg", walking: "Spacer 1–3 km", kids: "Tak, sprawnie chodzą", exposure: "Niska",
      ...
      agenda: [["12:30", "Wyjazd z Łodzi", "Sama jazda do BER to <strong>4 godziny 35 minut</strong> wg nawigacji. Z dwoma postojami po kwadransie jesteśmy na parkingu około 17:35, czyli spokojnie w oknie wjazdu. Bagaże spakować dzień wcześniej."], ["17:35", "Parking P7/8 przy BER", "Wjazd na rozpoznawanie tablicy EL2GE01 (rez. 8320774, okno 14:00–18:00). Nie wciskamy przycisku po bilet: automat sam wyda „online ticket”, zabieramy go i robimy zdjęcie miejsca postoju."], ["18:15", "Zameldowanie w hotelu", "IntercityHotel Berlin Airport BER Terminal 1+2, Willy-Brandt-Platz 5. Dwa pokoje Business Twin — potwierdzenia 4RGPYJYD i 4GMN9X9N. Wejście do Terminala 1–2 jest tuż obok, więc rano wystarczy kilka minut na dojście."], ["19:00", "Kolacja", "W hotelu albo w Terminalu 1–2, gdzie lokale są czynne do późna. Rachunek uregulować wieczorem albo skorzystać z ekspresowego wymeldowania — o 4:45 nie chcemy stać w recepcji."], ["21:00", "Wczesny sen", "Lot wychodzi o 07:00, pobudka o 4:45 — kładziemy się bez dyskusji."]],
      tips: ["Postoje trzymać krótkie — dwa po kwadransie wystarczą, żeby wjechać w okno rezerwacji (14:00–18:00). Trzy dłuższe przerwy przesuwają przyjazd po 18:00, a wtedy trzeba by liczyć na dobrą wolę obsługi przy szlabanie.",  "Do centrum Berlina jest stąd 25–30 minut pociągiem FEX albo S-Bahn z dworca pod terminalem, a przejazd mamy w cenie pokoju (H Rewards City Ticket). Przy przyjeździe po 18:30 i pobudce o 4:45 to jednak wyprawa na styk — jeśli ktoś ma siłę, można wyskoczyć na godzinę pod Bramę Brandenburską, ale wracamy najpóźniej o 22:00.", "Nocleg: IntercityHotel Berlin Airport BER Terminal 1+2 (Willy-Brandt-Platz 5, tel. +49 30 536 531 0) — wejście do Terminala 1–2 jest tuż obok, więc rano wystarczy kilka minut na dojście. Dwa pokoje Business Twin, potwierdzenia 4RGPYJYD i 4GMN9X9N; pokój jest zabezpieczony kartą, więc czeka też przy późnym przyjeździe.", "Rachunek za hotel uregulować wieczorem albo skorzystać z ekspresowego wymeldowania — o 4:45 nie chcemy stać w recepcji.", "Śniadania w hotelu nie mamy w rezerwacji — coś do jedzenia bierzemy ze sobą albo kupujemy rano po odprawie na lotnisku.", "Przed wyjazdem pobrać mapę offline Berlina i okolic BER.", "Parking P7/8 stoi przy terminalach (2–4 min pieszo), więc do hotelu idziemy piechotą — komplet danych parkingu i kod QR z nawigacją są w zakładce Praktyczne.", "Po drodze robić postoje najpóźniej co 90 minut; po przyjeździe zaplanować jeden spacer 1–3 km, bez długiego stania.", "Zostawić bagaże lotnicze łatwo dostępne — nie przepakowywać auta wieczorem."],
    ...
    },
    {
      ...
      agenda: [["08:15", "Śniadanie w hotelu", "Bufet 7:30–10:00 — zjeść przed wyjazdem o 10:15 (godziny potwierdzić w recepcji)."], ["10:15", "Wyjazd z Funchal autobusem 81", "Trasa w głąb wyspy i spokojne rozpoczęcie aktywnego pół dnia."], ["11:00", "Eira do Serrado", "Krótkie podejście do komfortowego punktu widokowego; kijki i przerwy według potrzeby."], ["12:15", "Curral das Freiras", "Spacer 2–3 km po miejscowości i spokojny lunch."], ["15:30", "Powrót do hotelu", "Popołudnie na basenie lub krótka promenada."]],
      tips: ["<strong>Autobus 81</strong> (Horários do Funchal) jedzie z centrum Funchal przez Eira do Serrado do Curral das Freiras — około 45 minut serpentynami i tunelami, bilet 2–3 € od osoby. W piątek jedzie czworo, czyli ~23 € w obie strony zamiast 60–70 € za taksówkę, a sama trasa jest atrakcją. Do przystanku w centrum dojedziemy taksówką spod hotelu (ok. 8 €) albo autobusem miejskim.", "Najtańszy i najciekawszy dojazd to <strong>autobus 81</strong> (Horários do Funchal): jedzie z centrum Funchal przez Eira do Serrado do Curral das Freiras, ok. 45 minut serpentynami i tunelami. Bilet ok. 2–3 € od osoby (z kartą GIRO taniej) — we czworo w obie strony ~23 €, podczas gdy taksówka to 60–70 €. Autobus zatrzymuje się przy punkcie widokowym.", "Podejście do punktu widokowego jest częścią planu przy suchej nawierzchni; zawrócenie pozostaje prostą opcją.", "Nie trzeba podchodzić do barierek, aby zobaczyć dolinę.", "W razie choroby lokomocyjnej usiąść z przodu i przygotować wodę.", "Dzieci mogą przejść pełny spacer; tempo dopasowujemy do najwolniejszej osoby."] ,
    ...
    {
      id: "2026-08-22", date: "22 sierpnia · sobota", title: "Funchal po swojemu", short: "Dołącza rodzina z Katowic, a wieczorem espetada — pierwsza kolacja w komplecie.",
    ...
    },
    {
      ...
      tips: ["Dzień bez wsiadania do niczego: Lido i promenada są w zasięgu spaceru od hotelu. Gdyby ktoś nie miał siły wracać pieszo, taksówka albo Bolt spod Lido do hotelu to 5–7 €.", "To jedyny w pełni luźny dzień — dobry moment na snorkeling, spacer po Starym Mieście albo popływanie, zależnie od chęci.", "Przy Lido sprawdzić warunki oceanu i komunikaty ratowników.", "Uzupełnić wodę, przekąski i drobiazgi przed aktywną wycieczką następnego dnia."],
    ...
    },
    {
      ...
      tips: ["Marina, muzeum CR7 i Stare Miasto leżą blisko siebie — między nimi chodzimy pieszo. Z hotelu w São Martinho do centrum jedzie autobus miejski (ok. 2 €) albo taksówka za 8–10 €; przy siódemce dwa kursy Bolta bywają tańsze niż taksówki z postoju.", "Trasa 2–4 km przez marinę, CR7 i wybrany fragment starego miasta jest planem podstawowym.", "Przerwa na siedząco co 45–60 minut; taxi zawsze pozostaje wygodną opcją.", "Kapelusze, woda i przerwa w cieniu w południe.", "Sprawdzić aktualne godziny otwarcia muzeum CR7."],
    ...
    },
    {
      ...
      intensity: "Spokojna", duration: "10:15–17:55", transport: "Bus, taxi-van albo linia 142", walking: "ok. 2–3 km, wszystko płasko", kids: "Tak — dzień pisany pod dzieci", exposure: "Żadna — wybrzeże i płaskie ścieżki",
    ...
    },
    {
      ...
      intensity: "Aktywna", duration: "09:45–18:30", transport: "Prywatny bus + PR1.2", walking: "PR1.2 6 km + Balcões 1,5 km", kids: "Tak, dobrze chodzą po górach", exposure: "Umiarkowana; PR1.2, bez grani PR1",
      center: [32.757, -16.925], route: [[32.6384, -16.9353, "Hotel"], [32.7573, -16.9110, "Achada do Teixeira — start PR1.2"], [32.7583, -16.9419, "Pico Ruivo (1862 m)"], [32.7900, -16.8540, "Faial — obiad"], [32.7353, -16.8865, "Ribeiro Frio"], [32.7419, -16.8905, "Balcões"], [32.6384, -16.9353, "Hotel"]], google: "https://www.google.com/maps/dir/Hotel+Baia+Azul,+Funchal/Achada+do+Teixeira/Ribeiro+Frio/Bal%C3%A7%C3%B5es",
      agenda: [["08:00", "Śniadanie w hotelu", "Bufet od 7:30 — dziś jemy na początku, bo wyjeżdżamy wcześniej niż zwykle. Zabrać prowiant na szlak: kanapki, owoce, batony."], ["09:45", "Wyjazd z hotelu", "Wyjątkowo przed 10:15 — slot na szlak mamy o 11:30, a do Achada do Teixeira jedzie się około 95 minut: autostradą do Santany, potem wąską, krętą ER218 wysoko w góry."], ["11:20", "Achada do Teixeira", "Parking na ~1590 m z zapasem kwadransa. Przy nim skalna formacja 'Homem em Pé'. Kurtki, buty, toaleta — spokojnie, okno wejścia trwa do 12:00."], ["11:35", "PR1.2 na Pico Ruivo", "Wejście w oknie 11:30–12:00 zgodnie z biletem. Najłatwiejsza droga na najwyższy szczyt wyspy (1862 m): 2,8 km w jedną stronę szeroką, kamienną ścieżką ze schodami. Z dziećmi i przerwami liczymy 3 h w obie strony — bez pośpiechu, prowiant zjadamy na szczycie."], ["14:45", "Zjazd do Faial", "Schodzimy z gór w stronę wybrzeża — Faial leży po drodze, przed podjazdem na Ribeiro Frio."], ["15:40", "Obiad w Faial", "Restauracja polecona przez naszego kierowcę: lokalna ryba i mięso, kuchnia przyjazna dzieciom. Prawie godzina przy stole — a geograficznie układa się idealnie, bo z Faial na Balcões dojeżdża się akurat na nasz slot."], ["16:35", "Podjazd na Ribeiro Frio", "Około 25 minut krętą ER103 w górę."], ["17:00", "Vereda dos Balcões", "Wejście zgodnie z biletem na 17:00 (okno do 17:30). Płaska, szeroka levada do tarasu widokowego — 1,5 km w obie strony, 45–60 minut. Idealna nagroda po szczycie: zero wysiłku, wielki widok."], ["18:00", "Powrót do Funchal", "Około 35 minut drogi w dół."], ["18:30", "Hotel", "Wieczór bez planów — po takim dniu nikt nie będzie chciał nigdzie wychodzić."]],
      tips: ["<strong>Rano, przy śniadaniu, jedno spojrzenie:</strong> <a href=\"https://www.madeira-web.com/en/webcams/pico-do-arieiro.html\" target=\"_blank\" rel=\"noopener\">kamera na Pico do Arieiro</a> pokazuje ten sam masyw co nasz szczyt. Jeśli góry wystają ponad chmury — jedziemy bez wahania; chmury na Maderze i tak zwykle rozchodzą się w południe, a nasze wejście jest o 11:30.", "<strong>Dojazd jest tu głównym ograniczeniem.</strong> Hotel → Achada do Teixeira to około 95 minut, a z powrotem w dół do Ribeiro Frio kolejne 65. Dlatego dzień ma tylko dwa przystanki po zejściu, a nie cztery — kierowca madeira-in zwrócił uwagę, że wcześniejsza wersja była nierealna.", "Bilety na oba szlaki mieć zapisane offline — zrzut ekranu albo PDF. Na Achada do Teixeira i w Ribeiro Frio zasięgu praktycznie nie ma.", "Bufory są wszędzie: na Achada jesteśmy kwadrans przed slotem, okno wejścia trwa do 12:00, a na szlak mamy ponad 3 h. Gdyby zejście się przeciągnęło, bilet na Balcões też ma okno do 17:30 — nic w tym dniu nie wisi na pięciu minutach.", "Prowiant zabrać z hotelu. Przy Achada do Teixeira nie ma sklepu ani kawiarni, a obiad wypada dopiero ok. 15:40 w Faial.", "Bus tego dnia to <strong>290 € gotówką</strong> — potwierdzone przez Rui: 220 € za standardowe okno do 17:00 plus dwie rozpoczęte godziny po 35 €, bo wracamy po 18:00. Płacimy na miejscu, banknoty przygotować wcześniej.", "Na wysokości 1600–1860 m bywa znacznie chłodniej i wietrzniej niż na wybrzeżu — warstwy, kurtka przeciwwiatrowa i czapka, nawet przy 26°C w Funchal.", "Blisko szczytu są krótkie odsłonięte fragmenty — dzieci prowadzimy od strony ściany i idziemy spokojnie.", "Kijki trekkingowe przydają się bardziej na zejściu niż na podejściu."],
  ...
  function dopasujKadr(mapa, wspolrzedne, L) {
    ...
    if (window.ResizeObserver && mapa.getContainer()) {
      ...
      mapObserver = new ResizeObserver(() => dopasuj());
      mapObserver.observe(mapa.getContainer());
    }
  }
    ...
    root.innerHTML = `
      <header class="print-head">
        ...
        <ul class="print-facts">
          ...
          <li><strong>Transfery lotniskowe:</strong> madeira-in (Rui Nóbrega), Mercedes Sprinter — 35 EUR za czworo, 45 EUR za siódemkę, plus osobny kurs 22.08 po rodzinę z Katowic. <strong>PŁATNE GOTÓWKĄ przy przyjeździe</strong>; tel. kierowcy +351 917 260 690, mail transfers.madeira@gmail.com. Po wylądowaniu dzwonimy do Rui z kompletem bagaży, odbiór przy kawiarni obok hali przylotów</li>
          ...
          <li><strong>Gotówka:</strong> transfery (Rui): 35 € 20.08 + kurs 22.08 + 45 € 30.08 · góry 27.08: 290 € potwierdzone · zachód 24.08 z Rui: 220–255 € · banany 26.08: taxi-van ~85–180 € albo Rui, decyzja na miejscu · Curral 21.08: autobus 81, ~40 € za rodzinę · minibus Rabaçal ~8 €/os. przy wariancie levady. Reszta wyspy na kartę.</li>
            ...
            <li><strong>Auto:</strong> parking APCOA P7/8 BER (Terminal T1&amp;T2), rez. 8320774, tablica EL2GE01, wyjazd 30.08 18:00, 144 € zapłacone; Brunolf-Baade-Straße 1/2. wjazd 19.08 w oknie 14:00–18:00</li>
  ...
  const KOSZTY_GOTOWKA = [
    { co: "Transfer z lotniska 20.08", staly: 35, uwaga: "Przylatuje czworo — jeden kurs Sprinterem. Rui przyjmuje wyłącznie gotówkę, przy przyjeździe, więc banknoty przygotować jeszcze w Polsce." },
    { co: "Transfer rodziny z Katowic 22.08", staly: null, uwaga: "Osobny kurs po dwoje dorosłych i sześciolatka, lot Enter Air z Katowic. Cena i dostępność do potwierdzenia z Ruim — zapytanie wysłane." },
    { co: "Transfer powrotny 30.08", g4: 35, g7: 45, uwaga: "Wracamy w komplecie, więc stawka jak za siódemkę. Godzinę odbioru trzeba jeszcze dograć: Rui zapisał 08:45, my liczymy na 08:30." },
    ...
    { co: "Autobus 81 do Curral 21.08", staly: 23, uwaga: "W piątek jedzie jeszcze czworo, po 2–3 € od osoby w jedną stronę; taniej z kartą GIRO." },
  ...
  function renderKoszty() {
    ...
    if (!host) return;
    const n = czytajSklad();
    const kwota = (r) => ("staly" in r ? r.staly : n === 4 ? r.g4 : r.g7);
  ...
  const practicalInfo = [
    ...
    { emoji: "💶", title: "Ile gotówki mieć przy sobie", points: [
      "<strong>Transfery lotniskowe — trzy kursy.</strong> 35 € przy przylocie 20.08 (jedzie czworo), osobny kurs 22.08 po rodzinę lecącą z Katowic (cena do potwierdzenia) i 45 € za powrót 30.08 w komplecie. Rui rozlicza się gotówką na miejscu, nie kartą i nie przelewem.",
      "<strong>Ok. 500–750 € — transport na wycieczki.</strong> Dzień górski 27.08 z Rui: <strong>290 € potwierdzone</strong> przez obie strony. Zachód 24.08 też z Rui: 220 € do 17:00, 255 € do 18:00 — na Fanal nic innego nie dojeżdża. Dzień bananowy 26.08 ma tańsze opcje: taxi-van do 8 osób za ~85–180 € albo linia 142 za grosze; decyzja na miejscu. Do Curral 21.08 jedzie autobus 81 za ~40 € za całą rodzinę.",
      ...
      <main id="main-content" class="guide-main">
        ...
        <section class="guide-section" aria-labelledby="rezerwacje-title">
          ...
          <div class="cash-alert">
            <strong>Gotówka na transfery: 35 € (20.08) + 45 € (30.08) + kurs po rodzinę 22.08.</strong> Rui bierze płatność <strong>gotówką przy przyjeździe</strong> — nie kartą, nie przelewem. Banknoty przygotować jeszcze w Polsce; bankomat na FNC to niepotrzebna komplikacja z bagażami i dziećmi po locie.
          </div>
          <div class="parking-box">
            <div class="parking-facts">
              ...
              <dl>
                ...
                <dt>Cena</dt><dd>35 € za kurs dla czworga, 45 € dla siódemki <span>— 20.08 przylatuje czworo, 30.08 wracamy w komplecie; osobny kurs 22.08 po rodzinę z Katowic, cena do potwierdzenia</span></dd>
              ...
              <ul class="info-list">
                ...
                <li>Dzień górski 27.08 jest potwierdzony przez Rui: odbiór 9:45, powrót ok. 18:30, 290 € gotówką. Pozostałe wycieczki ustalamy na miejscu — cena zależy od godziny powrotu (220 € do 17:00, 255 do 18:00, 290 później).</li>
              </ul>
            </div>
            <div class="parking-facts">
          ...
          <div class="parking-box">
            <div class="parking-facts">
              <dl>
                ...
                <dt>Wjazd</dt><dd>19.08.2026, 16:00 <span>— można wjechać w oknie 14:00–18:00; przy wyjeździe z Łodzi o 12:30 jesteśmy ok. 17:35</span></dd>
  ...
  function zamienDni(idA, idB, zapisz) {
    ...
    [FLEX, WEATHER_CRITICAL, WX_PUNKTY].forEach((m) => {
      const t = m[idA]; 
