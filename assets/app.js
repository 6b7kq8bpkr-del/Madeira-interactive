(function () {
  ...
  const CHECKLIST = [
    ...
    ["p8", "Rezerwacja APCOA 8320774 — mieć w telefonie potwierdzenie z ich odpowiedzią o późniejszym wjeździe (ok. 18:35)"],
  ...
  const days = [
    {
      ...
      intensity: "Łagodna", duration: "13:00–21:00, w tym 5,5 h drogi", transport: "Samochód · w Berlinie pociąg", walking: "Spacer 1–3 km", kids: "Tak, sprawnie chodzą", exposure: "Niska",
      ...
      agenda: [["13:00", "Wyjazd z Łodzi", "Sama jazda do BER to <strong>4 godziny 35 minut</strong> wg nawigacji, a z trzema postojami co ~90 minut robi się z tego około 5,5 godziny. Bagaże spakować dzień wcześniej — rano nie ma już czasu na szukanie."], ["18:35", "Parking P7/8 przy BER", "Wjazd na rozpoznawanie tablicy EL2GE01 (rez. 8320774). Wjazd po godzinie z rezerwacji jest w porządku — parkujemy krócej, nie dłużej; szczegóły we wskazówkach poniżej. Nie wciskamy przycisku po bilet: automat sam wyda „online ticket”, zabieramy go i robimy zdjęcie miejsca postoju."], ["19:15", "Zameldowanie w hotelu", "IntercityHotel Berlin Airport BER Terminal 1+2, Willy-Brandt-Platz 5. Dwa pokoje Business Twin — potwierdzenia 4RGPYJYD i 4GMN9X9N. Wejście do Terminala 1–2 jest tuż obok, więc rano wystarczy kilka minut na dojście."], ["19:45", "Kolacja przy terminalu", "Po pięciu godzinach w aucie i przy pobudce o 4:45 najrozsądniej zjeść na miejscu — w hotelu albo w Terminalu 1–2, gdzie lokale są czynne do późna. Rachunek uregulować wieczorem albo skorzystać z ekspresowego wymeldowania."], ["21:00", "Wczesny sen", "Lot wychodzi o 07:00, pobudka o 4:45 — kładziemy się bez dyskusji."]],
      tips: ["<strong>Dojedziemy około 18:35, czyli po godzinie z rezerwacji (16:00) — i to jest w porządku.</strong> Okres rezerwacji trwa od 19.08 16:00 do 30.08 18:00, więc wjeżdżamy w środku własnego, opłaconego okna. Regulamin APCOA przewiduje dopłatę tylko przy <em>wcześniejszym wjeździe albo późniejszym wyjeździe</em> — my parkujemy krócej, nie dłużej. Wspomniane w potwierdzeniu „dwie godziny” to wskazówka, kiedy kamera na pewno zadziała, a nie termin ważności rezerwacji. <strong>Nie ma powodu dopłacać 35 € za zmianę godziny.</strong> Dla pewności wysłaliśmy zapytanie do Reservierung.BER@apcoa.de — odpowiedź warto mieć w telefonie. Gdyby kamera nie przyjęła tablicy, na szlabanie jest przycisk „call help”, a obsługa pracuje całą dobę.", "Do centrum Berlina jest stąd 25–30 minut pociągiem FEX albo S-Bahn z dworca pod terminalem, a przejazd mamy w cenie pokoju (H Rewards City Ticket). Przy przyjeździe po 18:30 i pobudce o 4:45 to jednak wyprawa na styk — jeśli ktoś ma siłę, można wyskoczyć na godzinę pod Bramę Brandenburską, ale wracamy najpóźniej o 22:00.", "Nocleg: IntercityHotel Berlin Airport BER Terminal 1+2 (Willy-Brandt-Platz 5, tel. +49 30 536 531 0) — wejście do Terminala 1–2 jest tuż obok, więc rano wystarczy kilka minut na dojście. Dwa pokoje Business Twin, potwierdzenia 4RGPYJYD i 4GMN9X9N; pokój jest zabezpieczony kartą, więc czeka też przy późnym przyjeździe.", "Rachunek za hotel uregulować wieczorem albo skorzystać z ekspresowego wymeldowania — o 4:45 nie chcemy stać w recepcji.", "Śniadania w hotelu nie mamy w rezerwacji — coś do jedzenia bierzemy ze sobą albo kupujemy rano po odprawie na lotnisku.", "Przed wyjazdem pobrać mapę offline Berlina i okolic BER.", "Parking P7/8 stoi przy terminalach (2–4 min pieszo), więc do hotelu idziemy piechotą — komplet danych parkingu i kod QR z nawigacją są w zakładce Praktyczne.", "Po drodze robić postoje najpóźniej co 90 minut; po przyjeździe zaplanować jeden spacer 1–3 km, bez długiego stania.", "Zostawić bagaże lotnicze łatwo dostępne — nie przepakowywać auta wieczorem."],
    ...
    },
    {
      ...
      intensity: "Spokojna", duration: "10:15–18:15", transport: "Bus, taxi-van albo linia 142", walking: "ok. 2–3 km, wszystko płasko", kids: "Tak — dzień pisany pod dzieci", exposure: "Żadna — wybrzeże i płaskie ścieżki",
      ...
      <header class="print-head">
        ...
        <ul class="print-facts">
          ...
          <li><strong>Gotówka:</strong> 90 € transfery (Rui) · góry 27.08: 290 € potwierdzone · zachód 24.08 z Rui: 220–255 € · banany 26.08: taxi-van ~85–180 € albo Rui, decyzja na miejscu · Curral 21.08: autobus 81, ~40 € za rodzinę · minibus Rabaçal ~8 €/os. przy wariancie levady. Reszta wyspy na kartę.</li>
            ...
            <li><strong>Auto:</strong> parking APCOA P7/8 BER (Terminal T1&amp;T2), rez. 8320774, tablica EL2GE01, wyjazd 30.08 18:00, 144 € zapłacone; Brunolf-Baade-Straße 1/2. Dojeżdżamy ok. 18:35, czyli w środku opłaconego okresu — rezerwacji nie zmieniamy (dopłata dotyczy tylko wcześniejszego wjazdu lub późniejszego wyjazdu)</li>
          ...
          <div class="parking-box">
            <div class="parking-facts">
              <dl>
                ...
                <dt>Wjazd</dt><dd>19.08.2026, 16:00 <span>— dojedziemy ok. 18:35, czyli w środku opłaconego okresu (do 30.08 18:00). Dopłata należy się tylko za wcześniejszy wjazd lub późniejszy wyjazd, więc rezerwacji nie zmieniamy</span></dd>
