(function () {
  ...
  const CHECKLIST = [
    ...
    ["cash", "Gotówka: 90 € transfery + 290 € bus na dzień górski (potwierdzone); kolejne dni busa 220–290 € zależnie od godziny powrotu"],
    ...
    root.innerHTML = `
      <header class="print-head">
        ...
        <ul class="print-facts">
          ...
          <li><strong>Gotówka:</strong> 90 € transfery (Rui, przy przyjeździe) · bus: 220 € do 17:00 / 255 € do 18:00 / 290 € później — dzień górski 27.08 potwierdzony za 290 € · ok. 8 €/os. na minibus w Rabaçal przy wariancie z levadą. Reszta wyspy na kartę.</li>
  ...
  const practicalInfo = [
    ...
    { emoji: "💶", title: "Ile gotówki mieć przy sobie", points: [
      ...
      "<strong>Do ~800 € — wycieczki busem.</strong> Cennik madeira-in zależy od godziny powrotu: 220 € do 17:00, 255 € do 18:00, 290 € później (każda rozpoczęta godzina po 18:00 to +35 €). Dzień górski 27.08 jest potwierdzony za 290 €; dwa pozostałe rezerwujemy ad hoc i płacimy za każdy dzień osobno, gotówką.",
