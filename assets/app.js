(function () {
  ...
  const CHECKLIST = [
    ...
    ["cash", "Gotówka: 35 € transfer 20.08 + kurs po znajomych 22.08 + 35 € powrót 30.08 + 290 € góry; zachód 220–255 €, jeśli go zamówimy"],
  ...
  const KOSZTY_GOTOWKA = [
    ...
    { co: "Transfer rodziny z Katowic 22.08", staly: null, uwaga: "Osobny kurs Rui po dwoje dorosłych i pięciolatka. Itaka to u nich sam czarter — bez hotelu i bez shuttle'a, więc dojazd organizujemy sami. Cena do potwierdzenia, zapytanie wysłane." },
  ...
  const practicalInfo = [
    ...
    { emoji: "💶", title: "Ile gotówki mieć przy sobie", points: [
      "<strong>Transfery lotniskowe — trzy kursy u Rui.</strong> 35 € za przylot 20.08 i tyle samo za powrót 30.08 (oba we czworo), plus kurs 22.08 po znajomych z Katowic — cena do potwierdzenia. Rui rozlicza się gotówką na miejscu, nie kartą i nie przelewem.",
      ...
      <main id="main-content" class="guide-main">
        ...
        <section class="guide-section" aria-labelledby="rezerwacje-title">
          ...
          <div class="cash-alert">
            <strong>Gotówka na transfery: 2 × 35 € (20.08 i 30.08) plus kurs po znajomych 22.08.</strong> Rui bierze płatność <strong>gotówką przy przyjeździe</strong> — nie kartą, nie przelewem. Banknoty przygotować jeszcze w Polsce; bankomat na FNC to niepotrzebna komplikacja z bagażami i dziećmi po locie.
          </div>
          <div class="parking-box">
            <div class="parking-facts">
              ...
              <dl>
                ...
                <dt>Cena</dt><dd>35 € za kurs dla czworga <span>— tyle za przylot 20.08 i tyle za powrót 30.08; osobny kurs 22.08 po znajomych, cena do potwierdzenia</span></dd>
