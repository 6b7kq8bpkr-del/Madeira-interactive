(function () {
  ...
  const days = [
    ...
    },
    {
      ...
      agenda: [["09:30", "Start z hotelu", "Mercedes Sprinter madeira-in sprzed hotelu."], ["10:15", "Pico do Arieiro", "Rano szansa na czyste widoki jest największa — chmury zwykle narastają w ciągu dnia. Punkt widokowy i krótki spacer w komfortowym obszarze; bez trasy na Pico Ruivo."], ["11:45", "Ribeiro Frio i Balcões", "Łatwa levada do tarasu Balcões (ok. 1,5 km w obie strony) plus spacer po okolicy. Spokojne tempo i możliwość zawrócenia w dowolnym momencie."], ["13:30", "Santana i lunch", "Domki, odpoczynek i spokojny posiłek."], ["15:30", "Porto da Cruz lub Machico", "Jeden dodatkowy przystanek zależnie od czasu i pogody."], ["17:30", "Powrót", "Wieczór bez dodatkowego programu."]],
    ...
    },
    {
      ...
      intensity: "Bardzo łagodna", duration: "Dowolnie", transport: "Pieszo / taxi", walking: "Tylko według samopoczucia", kids: "Idealny", exposure: "Niska",
    ...
    },
    {
      ...
      intensity: "Pełna", duration: "09:30–17:30", transport: "Prywatny bus", walking: "Łącznie 3–5 km", kids: "Tak, sprawnie chodzą", exposure: "Niska; Cabo opcjonalne",
    ...
    },
    {
      ...
      agenda: [["09:30", "Wyjazd z Funchal", "Trasa w głąb wyspy i spokojne rozpoczęcie aktywnego pół dnia."], ["10:15", "Eira do Serrado", "Krótkie podejście do komfortowego punktu widokowego; kijki i przerwy według potrzeby."], ["11:45", "Curral das Freiras", "Spacer 2–3 km po miejscowości i spokojny lunch."], ["15:00", "Powrót do hotelu", "Popołudnie na basenie lub krótka promenada."]],
    ...
    {
      id: "2026-08-27", date: "27 sierpnia · czwartek", title: "Calheta i południowy zachód", short: "Bananowce w Madalena do Mar, plaża w Calhecie i słoneczne Ponta do Sol.",
      image: images.beach, alt: "Spokojne wybrzeże południowo-zachodniej Madery", cats: ["wycieczka busem", "spokojny"],
      intensity: "Umiarkowana", duration: "09:30–17:30", transport: "Prywatny bus", walking: "2–4 km", kids: "Bardzo dobry", exposure: "Niska",
      center: [32.7219, -17.1775], route: [[32.6384, -16.9353, "Hotel"], [32.7031, -17.1276, "Plantacje bananowców — Madalena do Mar"], [32.7219, -17.1775, "Plaża Calheta"], [32.7223, -17.1785, "Engenhos da Calheta"], [32.7370, -17.2115, "Jardim do Mar — opcjonalnie"], [32.6819, -17.1045, "Ponta do Sol"], [32.6384, -16.9353, "Hotel"]], google: "https://www.google.com/maps/dir/Madalena+do+Mar/Calheta+Beach/Engenhos+da+Calheta/Jardim+do+Mar/Ponta+do+Sol",
      agenda: [["09:30", "Wyjazd z hotelu", "Trzeci dzień madeira-in w spokojnym rytmie."], ["10:15", "Plantacje bananowców", "Madalena do Mar — spacer wśród bananowców: dzieci zobaczą, jak rosną banany, i spróbują owoców prosto z plantacji."], ["11:30", "Calheta", "Piaszczysta plaża i czas rodzinny bez pośpiechu."], ["13:00", "Lunch przy plaży", "Posiłek jeszcze w Calhecie, o normalnej porze dla dzieci — bez przesuwania na późne popołudnie."], ["14:15", "Engenhos da Calheta", "Krótka wizyta zależna od godzin otwarcia."], ["15:15", "Jardim do Mar opcjonalnie", "Leży tuż za Calhetą, więc wypada teraz — tylko jeśli grupa ma energię."], ["16:00", "Ponta do Sol", "Lody i spacer przy oceanie w drodze powrotnej do Funchal."], ["17:00", "Powrót", "Bez dokładania Rabaçal ani Risco."]],
      tips: ["Kolejność jedzie wzdłuż wybrzeża: najpierw plantacje w Madalena do Mar, najdalej Calheta i Jardim do Mar, a Ponta do Sol na deser w drodze powrotnej — bez cofania się.", "Zwiedzanie plantacji potwierdzić dzień wcześniej z kierowcą madeira-in; między bananowcami bywa parno, więc czapki i woda dla dzieci.", "Rabaçal i Risco nie są domyślną rekomendacją dla tej grupy — zgodnie z sugestią madeira-in, a nie z powodu niskiej kondycji dzieci.", "Według korespondencji madeira-in Risco nie jest dobrym wyborem przy problemie z klifami.", "Calheta i Ponta do Sol dają 2–4 km spacerów; Jardim do Mar można dodać, jeśli zostaje energia.", "Sprawdzić godziny Engenhos i zabrać rzeczy plażowe."],
      ...
      deepDive: {
        context: "Madalena do Mar to jedno z bananowych zagłębi Madery — plantacje schodzą tarasami niemal do samego oceanu, a maderska odmiana banana jest mniejsza i słodsza od tej znanej ze sklepów w Polsce. Plaża w Calheta to jedna z niewielu piaszczystych plaż na wyspie (piasek został sprowadzony), a Engenhos da Calheta to dawna gorzelnia trzciny cukrowej, wciąż produkująca lokalny rum i miód trzcinowy.",
        food: "Na plantacji w Madalena do Mar można spróbować bananów zerwanych na miejscu oraz przetworów — dżemów i suszonych owoców; w Engenhos da Calheta czeka rum i mel de cana (melasa trzcinowa), a w Ponta do Sol, najbardziej słonecznym zakątku wyspy, kawiarnie z widokiem na ocean.",
    ...
    },
    {
      ...
      tips: ["29 sierpnia jest terminem zapasowym rejsu — nie rezerwować na rano innej bezzwrotnej atrakcji.", "Jeśli rejs odbył się wcześniej, planujemy 2–5 km spaceru w Machico albo Funchal; kijki według nawierzchni.", "Machico daje aktywny, nisko położony wariant bez górskiej ekspozycji.", "Wieczorem zakończyć pakowanie i potwierdzić transfer."],
